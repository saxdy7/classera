            ...
            {isOpen && (
                <div className="px-6 py-2 space-y-2 max-h-40 overflow-y-auto mb-2">
                    {pins.map((pin) => (
                        <div
                            key={pin.id}
                            className="bg-card p-3 rounded-lg border border-accent-purple flex items-start gap-3 group"
                        >
                            ...
                            {isMentor && (
                                <button
                                    ...
                                    className="opacity-0 group-hover:opacity-100 p-1 hover:bg-muted rounded text-muted-foreground/70 hover:text-destructive transition-all"
                                    title="Unpin message"
                                >
                                    <X className="w-4 h-4" />
                                </button>
