                      ...
                      <div className="p-5 pt-4 bg-white border-t border-slate-100 flex gap-3">
                        {hasActiveChat(student.id) ? (
                          <Link
                            ...
                            className="flex-1 px-4 py-2.5 bg-indigo-600 text-white font-semibold rounded-xl text-sm hover:bg-indigo-700 transition-colors text-center"
                          >
                            💬 Message
                          </Link>
                          ...
                          <Link
                            href={`/dashboard/student/messages?userId=${student.id}`}
                            className="flex-1 px-4 py-2.5 bg-green-600 text-white font-semibold rounded-xl text-sm hover:bg-green-700 transition-colors text-center"
                          >
                            ✓ Connected
                          </Link>
                          ...
                          <button
                            disabled
                            className="flex-1 px-4 py-2.5 bg-yellow-100 text-yellow-700 font-semibold rounded-xl text-sm cursor-not-allowed"
                          >
                            ⏳ Pending
                          </button>
                        ) : (
                          <button
                            ...
                            className="flex-1 px-4 py-2.5 border-2 border-indigo-600 text-indigo-600 font-semibold rounded-xl text-sm hover:bg-indigo-50 transition-colors"
                          >
                            + Connect
                          </button>
                        )}
