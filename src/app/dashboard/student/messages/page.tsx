        ...
        <main className="flex-1 p-8">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-slate-600">Chat with your mentors and peers</p>
            </div>
                ...
                <div className="p-4 border-b border-slate-200">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-fuchsia-500 transition-colors"
                    />
                  </div>
                </div>
