  ...
  const notifications = [
    {
      ...
      message: 'Your assignment for Web Development has been successfully submitted.',
      time: '2 hours ago',
      read: false,
    },
    {
    ...
    },
    {
      ...
      type: 'warning',
      title: 'Upcoming Test',
      message: 'You have a test scheduled for tomorrow at 10:00 AM.',
      time: '1 day ago',
      read: true,
    },
    {
      ...
      message: 'Your mentor has replied to your question.',
      time: '2 days ago',
      read: true,
    },
  ];
