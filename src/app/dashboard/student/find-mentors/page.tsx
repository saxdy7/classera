    ...
    return (
      <div className="min-h-screen bg-[var(--cl-surface-card)] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[var(--cl-body)]">Loading mentors...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center justify-between gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-[var(--cl-body)] text-sm md:text-base leading-relaxed max-w-2xl">
                    Connect with experienced mentors from <span className="font-semibold text-[var(--cl-primary)]">{profile.universities?.name}</span> who can guide you in your learning journey
                  </p>
                  <div className="flex items-center gap-4 mt-4">
                    <div className="px-4 py-2 bg-[rgba(255,255,255,0.6)] backdrop-blur-sm rounded-[var(--cl-r-lg)] border border-[var(--cl-primary)]">
                      <span className="text-2xl font-semibold text-[var(--cl-primary)]">{filteredMentors?.length || 0}</span>
                      <span className="text-xs text-[var(--cl-body)] ml-2">{searchQuery || selectedExpertise !== 'All Expertise' ? 'Filtered' : 'Available'} Mentors</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              ...
              <div className="relative">
                <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--cl-primary)] pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                </svg>
                <select 
                  value={selectedExpertise}
                  onChange={(e) => setSelectedExpertise(e.target.value)}
                  className="pl-10 pr-10 py-3.5 bg-[var(--cl-surface-card)] border border-[var(--cl-hairline)] rounded-[var(--cl-r-xl)] focus:outline-none focus:ring-2 focus:ring-[var(--cl-primary)] focus:border-[var(--cl-primary)] font-medium text-[var(--cl-body)] min-w-[180px] appearance-none cursor-pointer transition-all"
                >
            ...
            {filteredMentors && filteredMentors.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredMentors.map((mentor, index) => {
                  const cardColors = [
                    { top: 'bg-[rgba(171,100,0,0.12)]', badge: 'bg-[rgba(171,100,0,0.12)] border-[var(--cl-warning)] text-[var(--cl-warning)]', accent: '#FB923C' },
                    { top: 'bg-[rgba(22,163,74,0.12)]', badge: 'bg-[rgba(22,163,74,0.12)] border-[var(--cl-success)] text-[var(--cl-success)]', accent: '#34D399' },
                    { top: 'bg-[var(--cl-primary-soft)]', badge: 'bg-[var(--cl-primary-soft)] border-[var(--cl-primary)] text-[var(--cl-primary)]', accent: '#A78BFA' },
                    { top: 'bg-[rgba(13,116,206,0.12)]', badge: 'bg-[rgba(13,116,206,0.12)] border-[var(--cl-info)] text-[var(--cl-info)]', accent: '#60A5FA' },
                    { top: 'bg-[var(--cl-primary-soft)]', badge: 'bg-[var(--cl-primary-soft)] border-[var(--cl-primary)] text-[var(--cl-primary)]', accent: '#F472B6' },
                    { top: 'bg-[var(--cl-canvas-soft)]', badge: 'bg-[var(--cl-surface-strong)] border-[var(--cl-hairline)] text-[var(--cl-body)]', accent: '#9CA3AF' },
                  ];
                      ...
                      <div className={`${colorScheme.top} p-5 relative`}>
                        ...
                        <div className="flex flex-wrap gap-2 min-h-[2.5rem] relative z-10">
                          ...
                          {mentor.specialization && (
                            <span className="px-3 py-1 rounded-full text-xs bg-[var(--cl-surface-card)] border border-black/10 text-[var(--cl-body)]">
                              {mentor.specialization}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center justify-between relative z-10">
                          ...
                          {(() => {
                            ...
                            if (connection?.status === 'accepted' || hasActiveChat) {
                              return (
                                <Link
                                  ...
                                  className="ml-3 text-[var(--cl-on-dark)] px-5 py-2.5 rounded-full text-sm font-semibold transition-all whitespace-nowrap flex items-center gap-2 bg-[var(--cl-primary)]"
                                >
                            ...
                            if (connection?.status === 'pending') {
                              return (
                                <div className="ml-3 bg-[var(--cl-surface-strong)] text-[var(--cl-muted)] px-5 py-2.5 rounded-full text-sm font-semibold border border-[var(--cl-hairline)] whitespace-nowrap flex items-center gap-2">
                            ...
                            return (
                              <Link
                                ...
                                className="ml-3 bg-black text-[var(--cl-on-dark)] px-5 py-2.5 rounded-full text-sm font-medium hover:bg-[var(--cl-surface-inverse)] transition-colors whitespace-nowrap"
                              >
                                Connect
                              </Link>
                            );
              ...
              <div className="rounded-[var(--cl-r-xl)] p-12 text-center border border-[var(--cl-hairline)] bg-[var(--cl-canvas)]">
                <div className="w-20 h-20 rounded-[var(--cl-r-xl)] flex items-center justify-center mx-auto mb-4 bg-[var(--cl-primary-soft)]">
                  <svg className="w-10 h-10 text-[var(--cl-primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-[var(--cl-body)] mb-4">
                ...
                {(searchQuery || selectedExpertise !== 'All Expertise') && (
                  <button
                    ...
                    className="px-6 py-2.5 bg-[var(--cl-primary)] hover:bg-[var(--cl-primary)] text-[var(--cl-on-dark)] rounded-[var(--cl-r-lg)] font-medium transition-all"
                  >
                    Clear Filters
                  </button>
                )}
