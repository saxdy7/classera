              ...
              <div className="border-t border-slate-200 pt-2">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-slate-900">Community Meeting</p>
                      <p className="text-xs text-slate-500">Tomorrow, 3:00 PM</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-1.5"></div>
                    <div className="flex-1">
                      <p className="text-sm font-medium text-slate-900">Test Review Session</p>
                      <p className="text-xs text-slate-500">Dec 30, 11:00 AM</p>
                    </div>
                  </div>
                </div>
              </div>
