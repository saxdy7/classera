...
import { User, Bell, Lock, DollarSign } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-black">Payment Settings</h3>
                    <p className="text-sm text-slate-600">Manage payment methods and earnings</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full text-left px-4 py-3 rounded-lg hover:bg-slate-50 transition-colors">
                    <p className="font-medium text-black">Earnings & Payouts</p>
                  </button>
                </div>
              </div>
            </div>
